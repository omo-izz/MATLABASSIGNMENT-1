...
tribeCounts = categorical(studentData.TRIBEASSOCIATION);
...
hostelCounts = categorical(studentData.HOSTEL_HALL);
pie(hostelCounts);
title('Student Distribution by Hall/Hostel');
legend(unique(studentData.HOSTEL_HALL), 'Location', 'eastoutside');
...
disp('All plots generated and saved as PNG files.');l
